...
public partial class ListenDay3 : Node2D
{
	...
	{
        if ((!Choice1Video.Visible && !Choice2Video.Visible && !Choice3Video.Visible && !LastFrameChoice1.Visible && !LastFrameChoice2.Visible && !LastFrameChoice3.Visible) && GlobalInfo.CurrentScene == 3 && GlobalInfo.CurrentDay == 3 && Visible && GetParent<Node2D>().Visible)
        {
    ...
    private void AfterVideoChoice1()
    {
        ...
        GlobalInfo.Day3IsWasOnListenScreen = true;
