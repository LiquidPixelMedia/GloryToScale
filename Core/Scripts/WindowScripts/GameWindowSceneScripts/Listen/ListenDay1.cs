...
public partial class ListenDay1 : Node2D
{
	...
	{
        if ((!Choice1Video.Visible && !Choice2Video.Visible && !Choice3Video.Visible && !LastFrameChoice1.Visible && !LastFrameChoice2.Visible && !LastFrameChoice3.Visible) && GlobalInfo.CurrentScene == 3 && GlobalInfo.CurrentDay == 1 && Visible && GetParent<Node2D>().Visible)
        {
    ...
    private void AfterVideoChoice1()
    {
        ...
        GlobalInfo.Day1IsWasOnListenScreen = true;
