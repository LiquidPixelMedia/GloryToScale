...
public partial class WriteDay3 : Node2D
{
    ...
    public override void _Process(double Delta)
    {
		if (GlobalInfo.CurrentDay == 3 && Visible && GetParent<Node2D>().Visible)
		{
			...
			if (IsChoice1CheckBoxEntered && TextAndWhySprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
			...
			if (IsChoice2CheckBoxEntered && TextWhatAReliefSprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
			...
			if (IsChoice3CheckBoxEntered && TextThanksToMrOverseerSprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
			...
			if (IsChoice4CheckBoxEntered && TextWhoIsBeingSprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
			...
			if (IsChoice5CheckBoxEntered && TextLooksLikeSprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
			...
			if (IsChoice6CheckBoxEntered && TextThisMustacheSprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
			...
			if (IsChoice7CheckBoxEntered && TextMaybeOnlyMustachioedSprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
			...
			if (IsChoice8CheckBoxEntered && TextWhatIsAPoliticianSprite.Visible && Input.IsActionJustPressed("LeftMouse") && Visible)
			{
